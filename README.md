...
## Временной анализ продаж (temporal analysis)

Исследованы динамика выручки по месяцам, дням недели и часам.

![Выручка по месяцам](temporal_analysis/monthly.png)
![Выручка по дням недели](temporal_analysis/weekday.png)
![Выручка по часам](temporal_analysis/hourly.png)

**Выводы:**
- Пик продаж приходится на ноябрь–декабрь (предновогодний сезон), спад в январе.
- Наибольшая выручка наблюдается во вторник и среду, наименьшая – в воскресенье (суббота отсутствует в данных).
- Активные часы покупок – с 10 до 16, максимальная активность в 12 часов дня.
